...
const footer = () => {
  return (
    <>
        <div className="footer  pb-10 pt-5">
          <div className="gmail-singup">
            ...
            <div className="subcription flex gap-2 mt-5">
              <input
                type="text"
                className="input-fill p-2 w-96 border rounded-full outline-none bg-transparent text-white"
        ...
        <div className="footer-content bg-slate-800 p-20">
          <div className="company-info">
            <img src={Logo} className="w-40" alt="" />
            
            <p className="w-96 text-sm pt-2">
